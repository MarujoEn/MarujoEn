...
[![GitHub](https://img.shields.io/badge/GitHub-181717?style=for-the-badge&logo=github&logoColor=white)](https://github.com/MarujoEn)
...
- **[RawFrame - C# CRUD Application](https://github.com/MarujoEn/Rawframe_Main_Application)**  
  Led development team in creating a complete Windows Forms application with text-file–based data persistence. Applied programming logic and project management principles.

- **[Educational Data Analysis](https://tinyurl.com/ArtigoMarujoEnsinoMedio)**  
  Critical analysis based on UNESCO and INEP data with practical solutions for the Brazilian New High School system and its structural challenges.
...
- **Technical Degree in Systems Development**  
  ETEC Professor Basilides de Godoy | Expected Completion: Dec/2026
  
- **High School Diploma**  
  E.E Ermano Marchetti | Completed: 2025

## 🏆 Relevant Certifications

- Python Development (60h) - SENAI (2025)
- Power BI Data Analysis (32h) - SENAI (2024)
- Hardware/Notebook Maintenance (80h) - Prime Cursos (2023)
